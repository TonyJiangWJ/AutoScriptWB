...
let { config, storage_name: _storage_name } = require('@/simpleConfig.js')
config.show_debug_log = true
config.async_save_log_file = false
let commonFunction = require('@/lib/prototype/CommonFunction')
let runningQueueDispatcher = require('@/lib/prototype/RunningQueueDispatcher')
let fileUtils = require('@/lib/prototype/FileUtils')
let formatDate = require('@/lib/DateUtil.js')
let paddleOcr = require('@/lib/prototype/PaddleOcrUtil')
let mlkitOcr = require('@/lib/prototype/MlkitOcrUtil')
...
let cutMode = false
//toastLog("截图成功")
let canvasWidth = Math.floor(device_width*0.8)
let canvasHeight = Math.floor(device_height*0.5)
let canvasHeight2 = Math.floor(device_height*0.2)
var canvasWindow = floaty.rawWindow(
  <vertical>
    <vertical id="vertical" bg="#aaaaaa" w="{{canvasWidth}}px" h="{{canvasHeight}}px" gravity="center">
    ...
    <vertical id="previewVertical" bg="#aaaaaa" w="{{canvasWidth}}px" h="{{canvasHeight2}}px" gravity="center">
