...
let customLockScreen = files.exists(FileUtils.getCurrentWorkPath() + '/extends/LockScreen.js') ? eval('require')(FileUtils.getCurrentWorkPath() + '/extends/LockScreen.js') : null
