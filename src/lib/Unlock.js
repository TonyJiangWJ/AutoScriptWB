 ...
 * @Description: 
 */
let { config: _config, storageName: _storageName } = require('@/secureConfig.js')
let automator = require('@/lib/prototype/Automator')
let { infoLog, logInfo, errorInfo, warnInfo, debugInfo } = require('@/lib/prototype/LogUtils')
let FileUtils = require('@/lib/prototype/FileUtils')
let _commonFunctions = require('@/lib/prototype/CommonFunction')
let _widgetUtils = require('@/lib/prototype/WidgetUtils')
let _runningQueueDispatcher = require('@/lib/prototype/RunningQueueDispatcher')
let ExternalUnlockDevice = files.exists(FileUtils.getCurrentWorkPath() + '/extends/ExternalUnlockDevice.js') ? eval('require')(FileUtils.getCurrentWorkPath() + '/extends/ExternalUnlockDevice.js') : null
...
let NORMAL_DEVICE = function (BaseUnlocker) {
...
const _unlocker = new MyDevice(Unlocker)
