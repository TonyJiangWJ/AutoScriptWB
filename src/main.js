...
let { logInfo, errorInfo, warnInfo, debugInfo, infoLog, debugForDev, flushAllLogs } = require('@/lib/prototype/LogUtils')
let FloatyInstance = require('@/lib/prototype/FloatyUtil')
let commonFunctions = require('@/lib/prototype/CommonFunction')
commonFunctions.delayIfBatteryLow()
let callStateListener = !config.is_pro && config.enable_call_state_control ? require('@/lib/prototype/CallStateListener') : { exitIfNotIdle: () => { } }
